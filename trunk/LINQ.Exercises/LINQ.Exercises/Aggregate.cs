...
namespace LINQ.Exercises
{
    ...
    public class Aggregate
    {
        ...
        {
            var result = TestData.Numbers.Count(number => number == 1);
        ...
        public void Count_all_animals_having_character_count_equal_to_5()
        {
            ...
            var result = TestData.Animals.Count(name => name.Count() == 5);
        ...
        {
            var result = TestData.Animals.Sum(name => name.Count());
        ...
        {
            var result = TestData.People.Sum(person => person.Born.Year);
        ...
        {
            var result = TestData.Animals.Min(name => name.Length);
        ...
        {
            var result = TestData.Animals.Max(name => name.Count());
        ...
        {
            DateTime result = TestData.People.Max(people => people.Born);
        ...
        {
            var result = TestData.People.Average(person => person.Born.Year);
