...
namespace LINQ.Exercises
{
    ...
    public class Restriction
    {
        ...
        {
            IEnumerable<int> result = TestData.Numbers.Select((x, index) => new {x, index}).Where(index % 2 != 0));
        ...
        {
            IEnumerable<string> result = TestData.Animals.Where(s => s.StartsWith("s"));
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => p.FirstName.StartsWith(p.LastName.First().ToString()));
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => 2000 - p.Born.Year >= 18);
        ...
        {
            IEnumerable<TestData.Person> result = TestData.People.Where(p => p.LastName.Contains("ll") && p.Born.Year + p.Born.Month + p.Born.Day > 2000);
